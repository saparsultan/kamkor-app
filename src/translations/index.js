const translations = {
  kk: {
    ...
    title: {
      ...
      listTours: 'Турлар тізімі',
      searchTourByID: 'Турды код бойынша іздеу',
      organization: 'Ұйым',
  ...
  ru: {
    ...
    titleTourAgent: 'Список турагентств системы гарантирования',
    youTravelAgent: 'Ваш туркод',
    problemsTour: 'Возникли проблемы с туром?',
    find: 'Найти',
    check: 'Проверить',
    selectTourAgent: 'Выберите своё турагентство из списка',
    listTours: 'Список туров',
    checkTourCode: 'Проверка туркода',
    sosRequest: 'SOS (Направить обращение)',
    noMyAgent: 'Моего агентства нет',
    contactConsultation: 'Свяжитесь с нами для дальнейшей консультации',
    emptyDesc: 'Возможно, турагентство, у которого вы приобрели тур, не состоит в списке агенств системы гарантирования Камкор, поэтому ваш туркод не отображается в нашей системе. Рекомендуется связаться с агентством, у которого вы приобрели тур.',
    contactKamkor: 'Получить консультацию',
    noTourAgent: 'Турагентства нету',
    signIn: 'Войти',
    save: 'Сохранить',
    ...
    placeholder: {
      ...
      tourAgent: 'Введите название турагентства',
    ...
    title: {
      ...
      listTours: 'Список туров',
      searchTourByID: 'Поиск тура по коду',
      organization: 'Организация',
      travelAgencyDirector: 'Директор турагентства',
      travelAgencyInfo: 'Данные о турагентстве',
