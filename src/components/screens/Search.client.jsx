          ...
          {tourCodeInfo !== null &&
              ...
              !loading && (
                  ...
                  <span className="main-grid__label">
                    ...
                    <Link
                        href={`https://api.whatsapp.com/send?phone=77478699525&text=Здравствуйте!🆘%0AПрошу оказать содействие в возврате в Казахстан.%0A%0AМои данные:%0AНомер тура в реестре: ${
                            searchData
                        },%0AНачало тура: ${
