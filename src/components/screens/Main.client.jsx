            ...
            <div className="main-wrapper">
                <div className="main-list">
                    <div className="main-item">
                        ...
                        <div
                            className="main-item__text">{userType === 'travel-agent' ? translations[locale].labels.travelAgent : translations[locale].labels.tourist}</div>
                    </div>
                    {
                        userType === "travel-agent" ?
                            <>
                                ...
                                {
                        travelAgentData?.info?.orgtype && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.orgname && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.tourfirmname && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.site && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.chieffname && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.email && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.cellphone && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.phone && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.country && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.address && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.description && <div className="main-item">
                    ...
                    {
                        travelAgentData?.info?.remarks && <div className="main-item">
                            ...
                            <div
                                ...
                                {
                                    travelAgentData?.info?.about && <div className="main-item">
                ...
                {
                    userType === 'tourist' &&
                    <Link href={`${links.main}/${links.edit}`} className="btn btn--primary main-link">
